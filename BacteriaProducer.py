class BacteriaProducer:
    ...
    def __init__(self, max_bacteria):
        ...
        self.current_bacteria_count = self.current_bacteria_count
    ...
    def create(self):
        if self.current_bacteria_count != self.max_bacteria and self.current_bacteria_count < self.max_bacteria:
